...
void AppDelegate::__Run()
{
    ...
    while (true)
    {
        ...
        {
            S2Application::GetInstance()->MainLoop();
            ::Sleep(5);
        }
    }
}
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
        S2MouseEvent *e = new S2MouseEvent(S2MouseEvent::Type::Move);
        e->mouseX = LOWORD(lParam); e->mouseY = HIWORD(lParam);
        S2Application::GetInstance()->GetDispatcher()->PushEvent(e, SEventFlag::AutoRelease);
    }break;
